...
public enum PrintMessage {
    ...
    INPUT_NAME_PRICE_QUANTITY_MSG(System.lineSeparator() + "상품명과 가격, 수량을 입력해 주세요."),
    INPUT_MONEY_AMOUNT_MSG(System.lineSeparator() + "투입 금액을 입력해 주세요."),
    INPUT_NAME_OF_PRODUCT_MSG(System.lineSeparator() + "구매할 상품명을 입력해 주세요."),
    /*
    OutputView
     */
